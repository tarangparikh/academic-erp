...
<head>
    ...
    <title>APro | Specialisation | View</title>
    ...
    <script src="${pageContext.request.contextPath}/assets/js/specialisation_update_validation.js"></script>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#modal_form_horizontal').on('show.bs.modal', function(e) {
                ...
                var course = getSpecialisatoinById(id);

                alert(JSON.stringify(course));
                if(course[1]===true){
                    alert(JSON.stringify(course[0]));
                    $('#specialisationName').val(course[0]['specialisationName']);
                    $('#specialisationTag').val(course[0]['specialisationTag']);
                    $('#specialisationCredits').val(course[0]['credits'])
            ...
            $('.delete_button').on('click', function() {
                var id = $(this).attr('id');
                var element = $('#'+id+'.specialisationVO');
                //alert(element.html());
                //alert(id);
                swal({
                    title: 'Are you sure?',
                    ...
                    if(willDelete.value){
                        var jsonResponse = deleteSpecialisation(id);
                ...
                <ul class="nav nav-sidebar" data-nav-type="accordion">
                    ...
                    <li class="nav-item nav-item-submenu nav-item-open nav-item-expanded">
                        ...
                        <ul class="nav nav-group-sub" data-submenu-title="Specialisation">
                            ...
                            <li class="nav-item"><a href="${pageContext.request.contextPath}/specialisation/view" class="nav-link active"><i class="icon-search4"></i><div class="col-6">View</div><div class="col-6"></div> </a></li>
                        </ul>
                    </li>
<%--                    <li class="nav-item">--%>
        ...
        <div class="content">
            ...
            <div class="card">
                <div class="card-header header-elements-inline">
                    <h5 class="card-title">View Specialisation</h5>
               ...
               <!-- <div class="card-body">
                ...
                <table class="table datatable-basic">
                    ...
                    <tr>
                        ...
                        <th>Course Tag</th>
                        <th>Credits</th>
                        <th hidden>Capacity</th>
                        <th>Status</th>
                        <th class="text-center">Actions</th>
                    </tr>
                    </thead>
                    <tbody>
                    <c:forEach items="${specialisation_list}" var="course">
                        <tr class="specialisationVO" id="${course.id}" >
                            <td>${course.specialisationName}</td>
                            <td>${course.specialisationTag}</td>
                            <td>${course.credits}</td>
                            <td hidden>${course.credits}</td>
