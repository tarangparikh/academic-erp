...
<head>
    ...
    <title>APro | Course | Create</title>
    ...
    <script src="${pageContext.request.contextPath}/assets/js/course_validation.js"></script>
    <script src="${pageContext.request.contextPath}/assets/js/rest_api.js"></script>
    <!-- /theme JS files -->
    <script type="text/javascript">
        $(document).ready(function(){

            /*jsonData = getCourseList();
            var multiSelectCourse = $('#courseOptions');

            for(var i in jsonData){
                multiSelectCourse.append(getAppendOption(jsonData[i]['courseTag'],jsonData[i]['courseName'],jsonData[i]['id']));
            }*/
            var cc = $('#courseCount');
            ...
            $('#courseOptions').populateCourses();
            $('#specialisatonOptions').populateSpecialisation();
            //alert(JSON.stringify(postCourse(strin)[0]));
       ...
       <!-- <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                <a href="#" class="navbar-nav-link">
                    ...
                    <span class="d-md-none ml-2">Novar cc = $('#courseCount');
           var sc = $('#specialisationCount');
           var ccount = getCourseCount();
           var scount = getSpecialisationCount();
           alert(JSON.stringify(scount));
                ...
                <ul class="nav nav-sidebar" data-nav-type="accordion">
                    ...
                    <li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
                        ...
                        <ul class="nav nav-group-sub" data-submenu-title="Course">
                            <li class="nav-item"><a href="${pageContext.request.contextPath}/course/create" class="nav-link active"><i class="icon-pen-plus"></i><div class="col-6">Create</div><div class="col-6"></div> </a></li>
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        <a href="index.html" class="breadcrumb-item"><i class="icon-home2 mr-2"></i> Course </a>
        ...
        <div class="content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    -->
                    <form class="form-validate-jquery"  id="courseForm" action="#">
                        <fieldset class="mb-3">
                            <legend class="text-uppercase font-size-sm font-weight-bold">Basic Course Addition</legend>
